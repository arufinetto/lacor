...
module.exports = function(app,passport) {
	...
	app.get('/api/excel', ControllerAnalisis.convertExcelToJson);
  	...
  	app.post('/api/analisis/:id/load-cm200', ControllerPedidos.loadAutomaticResult)
  ...
  app.get('/api/pedidos/open', ControllerPedidos.findAllOpens);
	...
	app.put('/api/pedidos/:id/update-identifier', ControllerPedidos.updateIdentifier);
  ...
  app.post('/api/save-result/counter19', ControllerPedidos.saveResultCounter19);
  app.get('/api/result/counter19/patient/:id', ControllerPedidos.getAutomaticResultCounter19);
};
