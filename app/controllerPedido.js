...
exports.saveResultCounter19 = function(req,res){
	//primero guardamos
var result = ""
...
Counter19.find({$and:[{patientId: formattedResult["ID"]},{date:date}]}, function(err, counter19) {
	if(counter19.length == 0){
		...
		console.log("HAY QUE ACTUALIZAR", counter19.length)
	}
})
...
exports.getAutomaticResultCounter19 = function(req, res) {
    Counter19.find({$and:[{patientId:req.params.id},{date:req.query.date}]}, function(err, counter19) {
		...
		response["patient"] = counter19[0].patientId,
		response["date"] = counter19[0].date,
		response["result"] = JSON.parse(counter19[0].parsedResult)
